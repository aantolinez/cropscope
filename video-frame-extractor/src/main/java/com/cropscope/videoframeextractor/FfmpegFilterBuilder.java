...
public final class FfmpegFilterBuilder {
    ...
    public FfmpegFilterBuilder setDropDuplicates(boolean v) {
        this.dropDuplicates = v;
        return this;
    }

    public FfmpegFilterBuilder setFps(Double v) {
        this.fps = v;
        return this;
    }

    public FfmpegFilterBuilder setSceneThreshold(Double v) {
        this.sceneThreshold = v;
        return this;
    }

    public FfmpegFilterBuilder setMinLumaYavg(Double y) {
        this.minLumaYavg = y;
        return this;
    }
